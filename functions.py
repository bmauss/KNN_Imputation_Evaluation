...
def knn_cat(df, target, frac_nan=0.1, n_neighbors=5, seed=None):
    ...
    Output: Report of the number of values removed and ratio to dataset. Report of the number of Perfect Estimations. Accuracy of KNN Imputation on categorical data.
    '''
    ...
    return print(f'Accuracy = {round((perfect_imputes/num_nan)*100, 3)}%')
